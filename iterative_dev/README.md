# Iterative development artefacts (archive)

Peer reviews, remediation reports, and early implementation plans, kept for the
record. They are not maintained as live documentation; read them for intent and
rationale, not as a current map of the codebase.
